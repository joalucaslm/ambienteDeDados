...
--
-- Table structure for table `restaurante_pagamento`
--

DROP TABLE IF EXISTS `restaurante_pagamento`;
...
--
-- Dumping data for table `restaurante_pagamento`
--

LOCK TABLES `restaurante_pagamento` WRITE;
/*!40000 ALTER TABLE `restaurante_pagamento` DISABLE KEYS */;
INSERT INTO `restaurante_pagamento` VALUES (1,1);
/*!40000 ALTER TABLE `restaurante_pagamento` ENABLE KEYS */;
UNLOCK TABLES;
