...
--
-- Table structure for table `restaurante_tipo_cozinha`
--

DROP TABLE IF EXISTS `restaurante_tipo_cozinha`;
...
--
-- Dumping data for table `restaurante_tipo_cozinha`
--

LOCK TABLES `restaurante_tipo_cozinha` WRITE;
/*!40000 ALTER TABLE `restaurante_tipo_cozinha` DISABLE KEYS */;
INSERT INTO `restaurante_tipo_cozinha` VALUES (1,1);
/*!40000 ALTER TABLE `restaurante_tipo_cozinha` ENABLE KEYS */;
UNLOCK TABLES;
